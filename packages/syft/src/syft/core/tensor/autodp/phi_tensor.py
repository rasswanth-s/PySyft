...
class PhiTensor(PassthroughTensor, ADPTensor):
    ...
    def view_copy(
        ...
        **kwargs: Any,
        ...
        # TODO: Add support for axes arguments later
        min_val = self.min_vals.view_copy(*args, **kwargs)
        max_val = self.max_vals.view_copy(*args, **kwargs)
    ...
    def expand_copy(
        ...
        **kwargs: Any,
        ...
        # TODO: Add support for axes arguments later
        min_val = self.min_vals.expand_copy(*args, **kwargs)
        max_val = self.max_vals.expand_copy(*args, **kwargs)
    ...
    def squeeze_copy(
        ...
        **kwargs: Any,
        ...
        # TODO: Add support for axes arguments later
        min_val = self.min_vals.squeeze_copy(*args, **kwargs)
        max_val = self.max_vals.squeeze_copy(*args, **kwargs)
    ...
    def fill(
        ...
        **kwargs: Any,
        ...
        # TODO: Add support for axes arguments later
        min_val = self.min_vals.fill(*args, **kwargs)
        max_val = self.max_vals.fill(*args, **kwargs)

        self.child.fill(*args, **kwargs)  # inplace operation
        return PhiTensor(
            child=self.child,
            min_vals=min_val,
            max_vals=max_val,
